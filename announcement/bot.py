...
class Announcement(Plugin):
        ...
        while True:
            try:
                ...
                if self.high_priority_queue:
                    ...
                    await asyncio.sleep(self.sleep_time)  # Sleep briefly if both queues are empty
                ...
                await asyncio.sleep(self.sleep_time)  # Wait based on the rate limit 
    ...
    async def start(self) -> None:
        ...
        self.rate_limit_per_second = 0.2 
